                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                             <div class="form-group">
                                ...
                                <input type="text" name="bobot_harga" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Bobot Gaming</label>
                                <input type="text" name="bobot_gaming" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                             <div class="form-group">
                                <label for="">Bobot Desain</label>
                                <input type="text" name="bobot_desain" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Bobot Coding</label>
                                <input type="text" name="bobot_coding" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="">Bobot Office</label>
                                <input type="text" name="bobot_office" class="form-control" required>
                            </div>     
                        </div>
                    </div>
