                ...
                <form action="update_bobot.php" method="post">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>Harga</label>
                        <input type="number" class="form-control" name="bobot_harga" required oninvalid="this.setCustomValidity('Harga Laptop belum diisi')" oninput="setCustomValidity('')" value="<?php echo $data['bobot_harga']?>">
                      </div>
                    </div>
